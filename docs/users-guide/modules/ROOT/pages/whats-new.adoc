= What's New in Grenki {page-component-version}
:description: The new features, changes, and bug fixes included in Grenki {page-component-version} and its patch releases.
:doctype: book
:route: New
...
== Grenki {page-component-display-version}
_**Release date:** TBD | *Issue label:* {url-milestone-3-2-0}[3.2.0^]_

The primary focus of Grenki {page-component-version} is to provide and refine certain API methods and endpoints to support the development of Grenki extensions.
...
Most important of all, a huge *thank you!* to all the folks who helped make Grenki even better.
